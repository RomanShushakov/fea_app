...
import { DELETE_POINT_BOUNDARY_CONDITION_MESSAGE_HEADER } from "../../../consts/actions_router_consts.js";
import { 
...
class FeaBoundaryConditionDeleteBoundaryConditionMenu extends HTMLElement {
    ...
    deleteBoundaryCondition() {
        ...
        const message = { [DELETE_POINT_BOUNDARY_CONDITION_MESSAGE_HEADER]: { 
            action_id: this.props.actionId, point_number: parseInt(selectedPointNumberField.value) 
        }};
