...
import { UPDATE_POINT_BOUNDARY_CONDITION_MESSAGE_HEADER } from "../../../consts/actions_router_consts.js";
...
class FeaBoundaryConditionUpdateBoundaryConditionMenu extends HTMLElement {
    ...
    defineBoundaryConditionOptions() {
        ...
        if (this.props.store.point_boundary_conditions_shelf.size > 0) {
            const pointsNumbers = Array.from(this.props.store.point_boundary_conditions_shelf.keys()).sort((a, b) => a - b);
    ...
    updateBoundaryCondition() {
        ...
        const oldBoundaryConditionValues = 
            this.props.store.point_boundary_conditions_shelf.get(parseInt(selectedPointNumberField.value));

        const message = { [UPDATE_POINT_BOUNDARY_CONDITION_MESSAGE_HEADER]: {
