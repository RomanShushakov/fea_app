...
import { ADD_LINE_MESSAGE_HEADER } from "../../../../consts/actions_router_consts.js";
...
class FeaGeometryAddLineMenu extends HTMLElement {
    ...
    defineNewLineNumber() {
        ...
        const sortedLinesNumbers = Array.from(this.props.store.lines_shelf.keys()).sort((a, b) => a - b);
        do {
            newLineNumber += 1;
    ...
    addLine() {
        ...
        if (newLineNumberField.value == "" || point1Field.value == "" || point2Field.value == "") {
            if (this.shadowRoot.querySelector(".analysis-info-message").innerHTML === "") {
                this.shadowRoot.querySelector(".analysis-info-message").innerHTML = 
        ...
        const message = { [ADD_LINE_MESSAGE_HEADER]: {
