...
import { UPDATE_POINT_MESSAGE_HEADER } from "../../../../consts/actions_router_consts.js";
...
class FeaGeometryUpdatePointMenu extends HTMLElement {
    ...
    definePointNumberOptions() {
        ...
        if (this.props.store.points_shelf.size > 0) {
            ...
            this.shadowRoot.querySelector(".point-x-coord").value = this.props.store.points_shelf.get(pointsNumbers[0]).x;
            this.shadowRoot.querySelector(".point-y-coord").value = this.props.store.points_shelf.get(pointsNumbers[0]).y;
            this.shadowRoot.querySelector(".point-z-coord").value = this.props.store.points_shelf.get(pointsNumbers[0]).z;
        } else {
    ...
    updatePointCoordinates() {
        ...
        this.shadowRoot.querySelector(".point-x-coord").value = this.props.store.points_shelf.get(parseInt(selectedPointNumber)).x;
        this.dropHighlight(this.shadowRoot.querySelector(".point-x-coord"));
        this.shadowRoot.querySelector(".point-y-coord").value = this.props.store.points_shelf.get(parseInt(selectedPointNumber)).y;
        this.dropHighlight(this.shadowRoot.querySelector(".point-y-coord"));
        this.shadowRoot.querySelector(".point-z-coord").value = this.props.store.points_shelf.get(parseInt(selectedPointNumber)).z;
    ...
    updatePoint() {
        ...
        const oldPointValues = this.props.store.points_shelf.get(parseInt(selectedPointNumberField.value));

        const message = { [UPDATE_POINT_MESSAGE_HEADER]: {
