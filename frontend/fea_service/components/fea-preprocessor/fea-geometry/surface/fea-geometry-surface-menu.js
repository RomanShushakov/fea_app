class FeaGeometrySurfaceMenu extends HTMLElement {
    constructor() {
        super();
        ...
        this.state = {
            activeMenuName: null,
            menuNames: {
                "geometry-add-surface-menu": "fea-geometry-add-surface-menu",
                "geometry-update-surface-menu": "fea-geometry-update-surface-menu",
                "geometry-delete-surface-menu": "fea-geometry-delete-surface-menu",
            },
        };
        ...
        <div class=wrapper>
            <fea-geometry-surface-menu-buttons></fea-geometry-surface-menu-buttons>
            <slot></slot>
        </div>
        `;
...
export default FeaGeometrySurfaceMenu;
