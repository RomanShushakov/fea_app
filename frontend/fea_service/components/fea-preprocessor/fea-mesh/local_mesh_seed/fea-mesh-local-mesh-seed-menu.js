class FeaMeshLocalMeshSeedMenu extends HTMLElement {
    constructor() {
        super();
        ...
        this.state = {
            activeMenuName: null,
            menuNames: {
                "lines-mesh-seed-menu": "fea-mesh-lines-mesh-seed-menu",
                "surfaces-mesh-seed-menu": "fea-mesh-surfaces-mesh-seed-menu",
            },
        };
        ...
        <div class=wrapper>
            <fea-mesh-local-mesh-seed-menu-buttons></fea-mesh-local-mesh-seed-menu-buttons>
            <slot></slot>
        </div>
        `;
...
export default FeaMeshLocalMeshSeedMenu;
