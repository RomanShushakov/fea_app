...
import { UPDATE_TRUSS_SECTION_MESSAGE_HEADER } from "../../../../consts/actions_router_consts.js";
import { 
...
class FeaSectionUpdateTrussMenu extends HTMLElement {
    ...
    defineTrussSectionNameOptions() {
        ...
        if (this.props.store.truss_sections_shelf.length > 0) {
            ...
            this.shadowRoot.querySelector(".area").value = this.props.store.truss_sections_shelf[0].area;
            this.shadowRoot.querySelector(".area2").value = this.props.store.truss_sections_shelf[0].area2;
        } else {
    ...
    updateTrussSectionData() {
        ...
        const trussSectionInProps = this.props.store.truss_sections_shelf
    ...
    updateTrussSection() {
        ...
        const oldTrussSectionValues = this.props.store.truss_sections_shelf
            .find(trussSection => trussSection.name == `"${selectedTrussSectionNameField.value}"`);
        
        const message = { [UPDATE_TRUSS_SECTION_MESSAGE_HEADER]: {
