...
import { ADD_CONCENTRATED_LOAD_MESSAGE_HEADER } from "../../../../consts/actions_router_consts.js";
...
class FeaLoadAddConcentratedLoadMenu extends HTMLElement {
    ...
    updateConcentratedLoadValues() {
        ...
        if (this.props.store.concentrated_loads_shelf.get(parseInt(selectedPointNumber)) !== undefined) {
    ...
    addConcentratedLoad() {
        ...
        const message = { [ADD_CONCENTRATED_LOAD_MESSAGE_HEADER]: {
