class FeaLoadConcentratedLoadMenu extends HTMLElement {
    constructor() {
        super();
        ...
        this.state = {
            activeMenuName: null,
            menuNames: {
                "load-add-concentrated-load-menu": "fea-load-add-concentrated-load-menu",
                "load-update-concentrated-load-menu": "fea-load-update-concentrated-load-menu",
                "load-delete-concentrated-load-menu": "fea-load-delete-concentrated-load-menu",
            },
        };
        ...
        <div class=wrapper>
            <fea-load-concentrated-load-menu-buttons></fea-load-concentrated-load-menu-buttons>
            <slot></slot>
        </div>
        `;
...
export default FeaLoadConcentratedLoadMenu;
