class FeaLoadUniformlyDistributedSurfaceLoadMenu extends HTMLElement {
    constructor() {
        super();
        ...
        this.state = {
            activeMenuName: null,
            menuNames: {
                "load-add-uniformly-distributed-surface-load-menu": "fea-load-add-uniformly-distributed-surface-load-menu",
                "load-update-uniformly-distributed-surface-load-menu": "fea-load-update-uniformly-distributed-surface-load-menu",
                "load-delete-uniformly-distributed-surface-load-menu": "fea-load-delete-uniformly-distributed-surface-load-menu",
            },
        };
        ...
        <div class=wrapper>
            <fea-load-uniformly-distributed-surface-load-menu-buttons></fea-load-uniformly-distributed-surface-load-menu-buttons>
            <slot></slot>
        </div>
        `;
...
export default FeaLoadUniformlyDistributedSurfaceLoadMenu;
