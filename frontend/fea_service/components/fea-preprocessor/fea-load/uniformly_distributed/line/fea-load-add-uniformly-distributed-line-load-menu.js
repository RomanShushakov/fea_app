...
import { ADD_UNIFORMLY_DISTRIBUTED_LINE_LOAD_MESSAGE_HEADER } from "../../../../../consts/actions_router_consts.js";
import { CLIENT_MESSAGE_HEADER, GET_WASM_LOADING_STATUS_MESSAGE_HEADER } from "../../../../../consts/fea_app_consts.js";


class FeaLoadAddUniformlyDistributedLineLoadMenu extends HTMLElement {
    constructor() {
        super();
    ...
    defineDistributedLineLoadOptions() {
        ...
        if (this.props.store.lines_shelf.size > 0) {
            ...
            if (this.props.store.lines_shelf.get(
                linesNumbers[0]).optional_uniformly_distributed_line_load) {
                this.shadowRoot.querySelector(".qx").value = 
                    this.props.store.lines_shelf.get(linesNumbers[0]).optional_uniformly_distributed_line_load[1];
                this.shadowRoot.querySelector(".qy").value = 
                    this.props.store.lines_shelf.get(linesNumbers[0]).optional_uniformly_distributed_line_load[2];
                this.shadowRoot.querySelector(".qz").value = 
                    this.props.store.lines_shelf.get(linesNumbers[0]).optional_uniformly_distributed_line_load[3];
            } else {
                this.shadowRoot.querySelector(".qx").value = "";
                this.shadowRoot.querySelector(".qy").value = "";
                this.shadowRoot.querySelector(".qz").value = "";
    ...
    updateDistributedLineLoadValues() {
        ...
        if (this.props.store.lines_shelf.get(
            parseInt(selectedLineNumber)).optional_uniformly_distributed_line_load) {
            this.shadowRoot.querySelector(".qx").value = this.props.store.lines_shelf.get(
                parseInt(selectedLineNumber)).optional_uniformly_distributed_line_load[1];
            this.dropHighlight(this.shadowRoot.querySelector(".qx"));
            this.shadowRoot.querySelector(".qy").value = this.props.store.lines_shelf.get(
                parseInt(selectedLineNumber)).optional_uniformly_distributed_line_load[2];
            this.dropHighlight(this.shadowRoot.querySelector(".qy"));
            this.shadowRoot.querySelector(".qz").value = this.props.store.lines_shelf.get(
                parseInt(selectedLineNumber)).optional_uniformly_distributed_line_load[3];
    ...
    addDistributedLineLoad() {
        ...
        const message = { [ADD_UNIFORMLY_DISTRIBUTED_LINE_LOAD_MESSAGE_HEADER]: {
...
export default FeaLoadAddUniformlyDistributedLineLoadMenu;
