...
import { DELETE_UNIFORMLY_DISTRIBUTED_LINE_LOAD_MESSAGE_HEADER } from "../../../../../consts/actions_router_consts.js";
...
class FeaLoadDeleteDistributedLineLoadMenu extends HTMLElement {
    ...
    deleteDistributedLineLoad() {
        ...
        const message = { [DELETE_UNIFORMLY_DISTRIBUTED_LINE_LOAD_MESSAGE_HEADER]: { 
            action_id: this.props.actionId, line_number: parseInt(selectedLineNumberField.value) 
        }};
