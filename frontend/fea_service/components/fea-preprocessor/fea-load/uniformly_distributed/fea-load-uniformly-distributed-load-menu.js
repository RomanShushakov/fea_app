class FeaLoadUniformlyDistributedLoadMenu extends HTMLElement {
    constructor() {
        super();
        ...
        this.state = {
            activeMenuName: null,
            menuNames: {
                "uniformly-distributed-line-load-menu": "fea-load-uniformly-distributed-line-load-menu",
                "uniformly-distributed-surface-load-menu": "fea-load-uniformly-distributed-surface-load-menu",
            },
        };
        ...
        <div class=wrapper>
            <fea-load-uniformly-distributed-load-menu-buttons></fea-load-uniformly-distributed-load-menu-buttons>
            <slot></slot>
        </div>
        `;
...
export default FeaLoadUniformlyDistributedLoadMenu;
